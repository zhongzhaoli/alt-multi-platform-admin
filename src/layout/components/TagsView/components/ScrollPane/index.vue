<template>
  <div class="scrollPane">
    <div class="scrollButton flex-center arrowLeft" @click="scrollTo('left')">
      <i class="ri-arrow-left-s-line" />
    </div>
    <el-scrollbar ref="scrollbarRef" @scroll="scroll">
      <div ref="scrollbarContentRef" class="scrollView">
        <slot />
      </div>
    </el-scrollbar>
    <div class="scrollButton flex-center arrowRight" @click="scrollTo('right')">
